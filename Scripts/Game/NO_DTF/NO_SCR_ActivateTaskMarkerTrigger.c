...
class NO_SCR_ActivateTaskMarkerTriggerClass: SCR_BaseTriggerEntityClass
{
};


class NO_SCR_ActivateTaskMarkerTrigger : SCR_BaseTriggerEntity
{
	...
	void Do(bool enter)
	{
		...
		ParentTask.m_bActivateTaskMarkerForThisTask = true;
